...
def saliency_3(frame, threshold=0.5):
    ...
    rbd = psal.get_saliency_rbd(frame).astype('uint8') #Saliency Optimization from Robust Background Detection, Wangjiang Zhu, Shuang Liang, Yichen Wei and Jian Sun, IEEE Conference on Computer Vision and Pattern Recognition (CVPR), 2014
